...
\foreach \animal [count=\i from 0, evaluate={\x=mod(\i,3)*5; \y=-floor(\i/3)*5;}]
 in {cat,cat2, dog, dog2}{ % bee,cat,chimpanzee,chipmunk,cow,dog,donkey,duck,horse,ladybird, monkey,owl,shark,
%  in {dog, dog2, squid, squid2}{ % bee,cat,chimpanzee,chipmunk,cow,dog,donkey,duck,horse,ladybird, monkey,owl,shark,
  % ,squid,squid2
