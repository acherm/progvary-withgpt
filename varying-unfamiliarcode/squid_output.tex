...
% \fill [DeepOrange300]
  ...
  (\fill [ Yellow50 ] ( -32, 108 ) circle [radius=16] ; 

  (\fill [ Blue500 ] ( -40, 160 ) circle [radius=12] ; 

  (\fill [ Blue500 ] ( -20, 196 ) circle [radius=8] ; 

  (\fill [ Blue500 ] ( 40, 160 ) circle [radius=16] ; 

  (\fill [ DeepOrange900 ] ( 64, 120 ) circle [radius=8] ; 

  (\fill [ Lime900 ] ( 40, 100 ) circle [radius=12] ; 

  (\fill [ Yellow50 ] ( 20, 140 ) circle [radius=10] ; 
